...
class _DriverListScreenState extends State<DriverListScreen> {
  ...
  Widget _buildResultView() {
    final isEmpty =
        drivers == null || drivers!.items == null || drivers!.items!.isEmpty;
    final int totalCount = drivers?.totalCount ?? 0;
    ...
    return Column(
      children: [
        CustomDataTableCard(
          ...
          emptySubtext: "Try adjusting your search or add a new driver.",
        ),
        SizedBox(height: 10),
        CustomPagination(
